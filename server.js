...
function validStrategy(s){return s&&/^\d+\.\d+\.\d+$/.test(s.version)&&[s.eatMealBelow,s.eatBerryBelow,s.fishBelow,s.trapThreatDistance,s.testSpeed,s.growthValueWeight].every(Number.isFinite)&&Array.isArray(s.craftPriority)&&s.craftPriority.every(x=>typeof x==='string')}
